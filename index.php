...
<head>
    ...
    <style>
        * {
        ...
        body {
            background-color:rgb(253,255,255,0.5); 
        }
...
<body>
    <nav>
          <img class="logo" src="./ceclogo.png" alt="">
    ...
    <div id="full">
        <div class="text">
            <h2>Electra-Online Voting System</h2>
...
<input type="hidden" name="access_key" value="4ee6161b-a323-453f-94a0-bfb8754ab7e4">
